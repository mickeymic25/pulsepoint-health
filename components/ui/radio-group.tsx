...
function RadioGroupItem({
  ...
  return (
    ...
    >
      ...
      >
        <CircleIcon className="fill-primary focus-visible:ring-primary/50 focus-visible:ring-[3px] absolute top-1/2 left-1/2 size-2 -translate-x-1/2 -translate-y-1/2" />
      </RadioGroupPrimitive.Indicator>
    </RadioGroupPrimitive.Item>
  );
}
